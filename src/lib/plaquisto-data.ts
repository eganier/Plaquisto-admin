...
export const plaquistoRecords:ReferenceRecord[]=[
  ...
  {id:"RULE-PLAFOND-RAMPANT",kind:"rule",title:"Règles — plafond rampant",summary:"Supports, isolation et recommandation de pare-vapeur applicables aux plafonds rampants.",sourcePage:0,status:"Publié",data:{category:"sloped_ceiling",schema_version:1,work_code:"plafond-fourrure-horizontal",allowed_supports:["Plancher bois horizontal","Charpente métallique"],excluded_lambdas_w_mk:[0.040],vapor_barrier_recommended:true,notes:["Le support bois est présenté comme « Support bois » dans l’application.","Les isolants de lambda 0,040 W/(m·K) ne sont pas proposés en rampant.","L’utilisateur peut poursuivre sans pare-vapeur après avoir confirmé l’avertissement."]}},
